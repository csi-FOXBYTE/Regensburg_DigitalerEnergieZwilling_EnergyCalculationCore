...
export const DEFAULT_CONFIG: DETConfig = {
  general: {
    ...
    energyEfficiencyClassColors: [
      { key: EnergyEfficiencyClass.A_PLUS, value: "#1B9E3E" },
      { key: EnergyEfficiencyClass.A, value: "#4CAF50" },
      { key: EnergyEfficiencyClass.B, value: "#6CB432" },
      { key: EnergyEfficiencyClass.C, value: "#B3CC2A" },
      { key: EnergyEfficiencyClass.D, value: "#ECDB23" },
      { key: EnergyEfficiencyClass.E, value: "#E8A824" },
      { key: EnergyEfficiencyClass.F, value: "#E67322" },
      { key: EnergyEfficiencyClass.G, value: "#D9381E" },
      { key: EnergyEfficiencyClass.H, value: "#A11A1A" },
    ],
