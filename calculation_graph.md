...
style SHt fill:#4CAF50

style user_roof_is_insulated fill:#4CAF50
style user_roof_is_heated fill:#4CAF50
style Dach_beheizt fill:#4CAF50
style Bg_Dach fill:#4CAF50

style const_F_OGD fill:#4CAF50
style const_Rsi_OGD fill:#4CAF50
style const_Sr_OGD fill:#4CAF50
style const_L_OGD fill:#4CAF50
style const_Rse_OGD fill:#4CAF50
style user_top_floor_area fill:#4CAF50
style user_top_floor_insulation_thickness fill:#4CAF50
style user_top_floor_is_insulated fill:#4CAF50
style user_top_floor_type fill:#4CAF50
style user_top_floor_year fill:#FFC107
style Bg_OGD fill:#FFC107
style F_OGD fill:#4CAF50
style Rsi_OGD fill:#4CAF50
style Rse_OGD fill:#4CAF50
style Sr_OGD fill:#4CAF50
style L_OGD fill:#4CAF50
style Rt_OGD_Dämmung fill:#4CAF50
style U_OGD_Decke fill:#4CAF50
style Rt_OGD_Decke fill:#4CAF50
style Rt_OGD fill:#4CAF50
style U_OGD0 fill:#4CAF50
style U_OGD1 fill:#4CAF50
style A_OGD1 fill:#4CAF50
style Ht_OGD fill:#4CAF50

style user_exterior_wall_area fill:#4CAF50
style user_exterior_wall_insulation_thickness fill:#4CAF50
style user_exterior_wall_is_insulated fill:#4CAF50
style user_exterior_wall_type fill:#4CAF50
style user_exterior_wall_year fill:#FFC107
style K_Aussenwand fill:#4CAF50
style Bg_Aussenwand fill:#FFC107
style const_F_Aussenwand fill:#4CAF50
style const_Rsi_Aussenwand fill:#4CAF50
style const_Sr_Aussenwand fill:#4CAF50
style const_L_Aussenwand fill:#4CAF50
style const_Rse_Aussenwand fill:#4CAF50
style F_Aussenwand fill:#4CAF50
style Rsi_Aussenwand fill:#4CAF50
style Rse_Aussenwand fill:#4CAF50
style Sr_Aussenwand fill:#4CAF50
style L_Aussenwand fill:#4CAF50
style Rt_Aussenwand_Dämmung fill:#4CAF50
style U_Aussenwand_Wand fill:#4CAF50
style Rt_Aussenwand_Wand fill:#4CAF50
style Rt_Aussenwand fill:#4CAF50
style U_Aussenwand0 fill:#4CAF50
style U_Aussenwand1 fill:#4CAF50
style A_Aussenwand1 fill:#4CAF50
style Ht_Aussenwand fill:#4CAF50

style user_basement_type fill:#4CAF50
style user_bottom_floor_area fill:#4CAF50
style user_bottom_floor_insulation_thickness fill:#4CAF50
style user_bottom_floor_is_insulated fill:#4CAF50
style user_bottom_floor_year fill:#FFC107
style Keller_beheizt fill:#FFC107
style Kellerdecke_massiv fill:#4CAF50
style Bg_UGD fill:#FFC107
style const_F_UGD fill:#4CAF50
style const_Rsi_UGD fill:#4CAF50
style const_Sr_UGD fill:#4CAF50
style const_L_UGD fill:#4CAF50
style const_Rse_UGD fill:#4CAF50
style F_UGD fill:#4CAF50
style Rsi_UGD fill:#4CAF50
style Rse_UGD fill:#4CAF50
style Sr_UGD fill:#4CAF50
style L_UGD fill:#4CAF50
style Rt_UGD_Dämmung fill:#4CAF50
style U_UGD_Decke fill:#4CAF50
style Rt_UGD_Decke fill:#4CAF50
style Rt_UGD fill:#4CAF50
style U_UGD0 fill:#4CAF50
style U_UGD1 fill:#4CAF50
style A_UGD1 fill:#4CAF50
style Ht_UGD fill:#4CAF50
